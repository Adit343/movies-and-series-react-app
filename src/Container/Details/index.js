...
const DetailsContainer = ()=>{
    ...
    //params: this variable stores the parameters extracted from the URL using useParams().it likely contains information like 'movieid' and 'mediatype'
    const params = useParams();


    //these are state variables which are used to store data fetched from external APIs.
    ...
    //these functions use Axios to fetch data from different endpoints of the movie database API

    //fetches general info about the movie or TV show 
    ...
    //fetches information about cast 
    ...
    //useEffect is used to trigger the data fetching when component is mounted.
    useEffect(()=>{
        fetchData();
        fetchVideo();
        creditsFetch();
    ...
    //this function generates HTML content using the fetched data including the movie or TV show's title,image,rating and other details
